...
An AI-powered learning companion proposal for [Seekho](https://seekho.in), a micro-learning platform with 25M+ monthly active users in India.
...
saathi demo
```
>Please note : When you run the above command, the browser will automatically start and there will be slight delay before you can start interacting.
...
- **Submit** button must be clicked when questions or recall are given to move on to the next step
